...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_dir', type=str, default='/home/xiaoxiao/dataset/dtu_official/SampleSet/MVS_Data')
    ...
    GT_DIR = "/home/xiaoxiao/dataset/dtu_official/Points/stl"

    # scans = [24, 37, 40, 55, 63, 65, 69, 83, 97, 105, 106, 110, 114, 118, 122]
    scans = [65]

    for scan in scans:
        base_dir = f"/home/xiaoxiao/Workplace/open_surface/UdfNeuS/exp/udf/dtu/mesh/ours/scan{scan}"
        print("processing scan%d" % scan)
        base_dir = "/home/xiaoxiao/Workplace/open_surface/UdfNeuS/exp/udf/dtu/ablation/with_patch"

        args.data = os.path.join(base_dir, "visualhull_%03d.ply" % scan)

        if not os.path.exists(args.data):
            continue

        args.gt = os.path.join(GT_DIR, "stl%03d_total.ply" % scan)
        args.vis_out_dir = os.path.join(base_dir, "udf_meshes/scan{}".format(scan))
        args.scan = scan
        os.makedirs(args.vis_out_dir, exist_ok=True)
